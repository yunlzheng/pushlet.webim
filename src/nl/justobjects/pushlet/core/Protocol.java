...
public interface Protocol {
	...
	/**
	 * new File add By zheng
	 * */
	public static final String Z_ACTION ="action";
	public static final String Z_LOGIN = "login";
	public static final String Z_ACCOUNT = "user";
	public static final String Z_PASS = "password";

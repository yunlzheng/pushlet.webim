...
import com.mappowers.dao.UserDAO;
import com.mappowers.model.User;
import com.mappowers.util.ConnFactory;
...
public class Pushlet extends HttpServlet implements Protocol{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("GET zheng:(Pushlet)"+event);
	...
	protected void doRequest(Event anEvent, HttpServletRequest request, HttpServletResponse response) {
		...
		String action = ""; 
		action = anEvent.getField(Z_ACTION);
		System.out.println("action:"+action);
		
		if(action!=null&&action.equals(Z_LOGIN)){
			
			String name = anEvent.getField("user");
			String password = anEvent.getField("password");
			System.out.println("name:"+name+",pass:"+password);
			Connection cn = ConnFactory.getConn();
			...
			System.out.println("ÓÃ»§µÇÂ¼,name:"+user.getName()+",password:"+user.getPassword());

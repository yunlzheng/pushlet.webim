...
public class Controller implements Protocol, ConfigDefs {
	...
	public void doCommand(Command aCommand) {
		...
		try {
			...
			//String refershURL ="zheng:"+aCommand.httpReq.getRequestURI() + "?" + Protocol.P_ID + "=" + session.getId() + "&" + Protocol.P_EVENT + "=" + Protocol.E_REFRESH;
			//info(refershURL);
			...
			if (eventType.equals(Protocol.E_REFRESH)) {
				...
				aCommand.httpReq.getRequestURI();
				...
				//System.out.println("subscribe取消订阅");
